...
def run_embedding(
    ...
    """
    from module.model import Embedding
...
def run_swiglu(
    ...
    from module.model import SwiGLU
    swiglu = SwiGLU(d_model, d_ff)
    swiglu.linear1.weights.data = w1_weight
    swiglu.linear2.weights.data = w2_weight
    swiglu.linear3.weights.data = w3_weight
...
def run_get_lr_cosine_schedule(
    ...
    """
    from module.optimizer import learning_rate_schedule
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    from module.tokenizer import train_BPETokenizer
    return train_BPETokenizer(
        input_path=input_path,
        vocab_size=vocab_size,
        special_tokens=special_tokens
    )
